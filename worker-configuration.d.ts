/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3d81f9668533287c8180cc4412e08c51)
// Runtime types generated with workerd@1.20260515.1 2026-05-19 nodejs_als
interface __BaseEnv_Env {
	AI: Ai;
	ASSETS: Fetcher;
	ARGUS_MODEL: "@cf/moonshotai/kimi-k2.6";
	ARGUS_FALLBACK_MODEL: "@cf/meta/llama-4-scout-17b-16e-instruct";
	ARGUS_RESEARCH: Workflow<Parameters<import("./.svelte-kit/cloudflare/_worker").ArgusResearchWorkflow['run']>[0]['payload']>;
}
